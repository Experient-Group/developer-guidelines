...
class ConcreteFactory1(AbstractFactory):
    ...
    def create_product_a(self) -> AbstractProductChair:
        return ConcreteProductA1()

    def create_product_b(self) -> AbstractProductSofa:
...
class ConcreteProductA1(AbstractProductChair):
    def useful_function_a(self) -> str:
        return "The result of the product A1."


class ConcreteProductA2(AbstractProductChair):
    def useful_function_a(self) -> str:
        return "The result of the product A2."


class AbstractProductSof(ABC):
    """
    ...
    @abstractmethod
    def another_useful_function_b(self, collaborator: AbstractProductChair) -> None:
        """
...
class ConcreteProductB1(AbstractProductSof):
...
class ConcreteProductB2(AbstractProductSof):
    def useful_function_b(self) -> str:
        return "The result of the product B2."

    def another_useful_function_b(self, collaborator: AbstractProductChair):
        """
